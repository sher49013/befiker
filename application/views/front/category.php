			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordian" href="#<?php echo str_replace(' ', '_', $maincat->category_name);?>">
				...
				<div id="<?php echo str_replace(' ', '_', $maincat->category_name);?>" class="panel-collapse collapse">
