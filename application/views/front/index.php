...
<head>
	...
	<title>Home | waqas-enterprisess</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0321-6086608</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> waqasenterprisess01@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="companyinfo">
							<h2><span>waqas</span>-enterprisess</h2>
...
<!--					</div>-->
		...
		<div class="footer-bottom">
                ...
                <script type="text/javascript">
                    (function () {
                        var options = {
                            whatsapp: "03216086608", // WhatsApp number
			...
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2020 Waqas-Enterprisess Inc. All rights reserved.</p>
					<p class="pull-right">Develop by <span>ALI SHER sher49013@gmail.com</span></p>
				</div>
			</div>
		</div>
