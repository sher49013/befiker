				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_total">
								<p class="cart_total_price"><?php echo $items['subtotal']?>/-RS</p>
							</td>
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							?>
							<li>Cart Sub Total <span><?php echo $cart_total;?>/-RS</span></li>
							<?php
								$tax = ($cart_total*0)/100;
							?>
							<li>Eco Tax 0% <span><?php echo $tax?>/-RS</span></li>
							...
							?>
							<li>Shipping Cost <span><?php echo $shiping?>/-RS</span></li>
							<?php $g_total = $cart_total+$tax+$shiping;?>
							<li>Total <span><?php echo $g_total;?>/-RS</span></li>
						</ul>
							<form action="<?php echo base_url()?>update-cart-qty-payment" method="post" >	
					...
					<form action="<?php echo base_url()?>place-order" method="post" >
						<div class="payment-options">
							<div class="order-message">
								...
								<textarea name="payment_message" required  placeholder="Notes about your order, Special Notes for Delivery Address" rows="10"></textarea>
							</div>	
							<span>
