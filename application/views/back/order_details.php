                ...
                <div class="row">
                     <div class="col-lg-12">
                         ...
                         <h5>
							 ...
							 <h5>
								 Address: <?php echo $order_info->payment_message;
								 ?>
							 </h5>
                         </div>
                     </div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<h5>
							Order Status <b><?php echo $order_info->order_status?></b>  <a class="btn btn-info" href="<?php echo base_url()?>status-order/<?php echo $order_info->order_id?>">Change Order Status</a>
						</h5>
						<h5>
							Payment Status <b><?php echo $order_info->payment_status; ?></b>  <a class="btn btn-info" href="<?php echo base_url()?>status-payment/<?php echo $order_info->payment_id?>">Change Payment Status</a>
						</h5>
					</div>
				</div>
			</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $order->product_price;?>/-RS</td>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                           <h4><strong>Sub-Total: </strong><?php echo $total?>/-RS</h4>
                           <h4><strong>Vat 0%: </strong><?php echo $vat = $total*0/100;?>/-RS</h4>
                           <h4><strong>Grand-Total: </strong><?php echo $vat+$total;?>/-RS</h4>
                        </div>
